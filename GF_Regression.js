...
var gruntConfig = {
    ...
    simplemocha: {
        ltr: {
            ...
            'test/sauce/sanity/concepttracker/conceptTracker.js',
            'test/sauce/sanity/CASExpositionAssignments.js',
            'test/sauce/sanity/chapter*.js',
            'test/sauce/sanity/chapterTileImageFeaturedItemCarousalViewValidation.js',
            'test/sauce/sanity/course*.js',
            'test/sauce/sanity/editAssignmentAndResumeQuiz.js',
            'test/sauce/sanity/exhibitAndImageStudybitAndInlineChapterLinkValidation.js',
            'test/sauce/sanity/gatewayassignmentvalidation.js',
            'test/sauce/sanity/smokeFeatures.js',
            'test/sauce/sanity/student*.js',
            'test/sauce/sanity/validate*.js',
            'test/sauce/sanity/validatingAndReviewingPublisherFlashcards.js',
            'test/sauce/sanity/verifyTopicsDisplayAndNavigation.js',
          ]
